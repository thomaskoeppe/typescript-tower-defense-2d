...
export class Catapult extends AbstractTower {
    public static readonly config: TowerParams = {
        ...
        level: {
            1: {
                weapon: {
                    sprite: 'weapons-2-lvl-0',
                    frame: 0,
                    shootAnim: 'weapons-2-lvl-0-shoot',
                    shootFrame: 2,
                    offsetX: 0,
                    offsetY: -8,
                    cooldown: 1000,
            ...
            2: {
                weapon: {
                    sprite: 'weapons-2-lvl-1',
                    frame: 0,
                    shootAnim: 'weapons-2-lvl-1-shoot',
                    shootFrame: 2,
                    offsetX: 0,
                    offsetY: -24,
                    cooldown: 1500,
            ...
            3: {
                weapon: {
                    sprite: 'weapons-2-lvl-2',
                    frame: 0,
                    shootAnim: 'weapons-2-lvl-2-shoot',
                    shootFrame: 2,
                    offsetX: 0,
                    offsetY: -32,
                    cooldown: 2000,
    ...
    constructor (scene, v) {
        super(scene, v, Catapult.config);
    }

    static create (scene, v): AbstractTower {
        return new Catapult(scene, v);
    }
}
